        ...
        <Element id="projects" name="projects">
                ...
                <div className="flex justify-center">
                    <div className="block p-12 m-12 rounded-lg shadow-lg bg-white max-w-md">
                        ...
                        <a href="https://github.com/phiwe-saba/We-Reccruit-Application" className=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                View Project.
                        </a>
                    </div>
